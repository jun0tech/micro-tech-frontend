        ...
        <div className="bg-white/80 backdrop-blur-md rounded-lg border border-gray-200/50 p-8 shadow-sm">
          ...
          <div className="mt-8 mb-6">
            ...
            <div className="mt-6">
              <button
                type="button"
                className="w-full flex justify-center items-center px-4 py-3 border border-gray-300/80 rounded-md text-gray-700 bg-white/70 hover:bg-white transition-colors duration-200 font-medium"
              >
